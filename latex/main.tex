...
\def\vBearbeitungszeitraum{01.10.2022 -}            %% DD.MM.YYYY - DD.MM.YYYY
...
\begin{document}
  ...
  \include{chapter/Konzeption}
  \include{chapter/UmsetzungVersuchssystem}
  \include{chapter/UmsetzungDemosystem}
