...
Wie in Kapitel~\ref{sec:UmsetzungServer} bereits vorweggenommen, wird das neuronale Netz für die Verwendung in dem Demosystem erneut Trainiert, wobei die Epochen von 250 auf 500 erhöht werden.
