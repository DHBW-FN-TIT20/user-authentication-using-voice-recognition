...
\newline
\ac{ML} lässt sich in die drei Kategorien überwachtes Lernen, unüberwachtes Lernen und verstärktes Lernen gliedern.
...
Verstärktes Lernen ist ein verhaltensbasiertes Lernmodell.
...
\newline
Im Kontext zu \acl{ML} stehen die neuronalen Netze, diese bilden den eigentlichen Lernprozess ab.
Ein neuronales Netz ist Nachstellung des menschlichen Gehirns und orientiert sich an dem biologischen Lernprozess. 
