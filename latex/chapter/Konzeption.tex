...
Die Literaturrecherche hat ergeben, dass sich neuronale Netze gut als Klassifikations-Modell eignen (siehe Kapitel \ref{stand_der_technik}). 
...
Anschließend werden die neuronalen Netze mit Testsdaten getestet, die nicht in den Trainingsdaten enthalten sind.
...
Hierzu wird zunächst basierend auf den vorangegangenen Definitionen ein Klasendiagramm erstellt.
In einem Folgeschritt wird der Ablauf in einem Sequenzdiagramm dargestellt. % optional
\newparagraph
Das Klassendiagram ist in der Abb. \ref{fig:klassendiagram-versuchssystem} dargestellt.
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth, keepaspectratio]{images/klassendiagram-versuchssystem.pdf}
    \caption{Klassendiagram Versuchssystem}
